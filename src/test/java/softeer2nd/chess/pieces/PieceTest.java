...
public class PieceTest {
    ...
    public void createPiece() {
        ...
        Piece whiteKnight = Piece.createWhiteKnight(new Point(0, 0));
        Piece blackKnight = Piece.createBlackKnight(new Point(0, 0));

        Piece whiteRook = Piece.createWhiteRook(new Point(0, 0));
        Piece blackRook = Piece.createBlackRook(new Point(0, 0));

        Piece whiteBishop = Piece.createWhiteBishop(new Point(0, 0));
        Piece blackBishop = Piece.createBlackBishop(new Point(0, 0));

        Piece whiteQueen = Piece.createWhiteQueen(new Point(0, 0));
        Piece blackQueen = Piece.createBlackQueen(new Point(0, 0));
